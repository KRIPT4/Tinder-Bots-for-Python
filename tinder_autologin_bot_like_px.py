#!/usr/bin/env python
"""
@name:tinder_autologin_bot_like_px.py - Tinder AutoLogin Bot Like (Proxy Version)
...
def mainExe():
	...
	## LIKE
	for i in range(0,50):
		retryElement('//*[@id="content"]/div/span/div/div[1]/div/main/span/div[2]/div/div/div[1]/div[2]/button[3]').click()
		time.sleep(3)
	## END LIKE
